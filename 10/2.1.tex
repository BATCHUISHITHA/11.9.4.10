...
\begin{align}
 y(n)&=x(n)*u(n) \\
x(n)&= (2n+1)^2 u(n) \\
   u(n) &\xleftrightarrow{\mathcal{Z}} \frac{1}{(1-z^{-1})}  \quad \abs{z}>1\\
   nu(n) &\xleftrightarrow{\mathcal{Z}} \frac{z^{-1}}{(1-z^{-1})^2} \quad \abs{z}>1\\
...
\begin{align}
 ...
 \begin{equation}
 Y(Z)=\frac{1}{(1-z^{-1})} +\frac{9z^{-1}}{(1-z^{-1})} + \frac{25z^{-2}}{(1-z^{-1})^2} + \frac{24z^{-3}}{(1-z^{-1})^3} + \frac{8z^{-4}}{(1-z^{-1})^4} \quad \abs{z}>1  \label{eq:11.9.4.10.eq}
 \end{equation}

By using  inverse Z-transform pairs,
\begin{align}
Z^{-1}\sbrak{\frac{z^{-1}}{1-z^{-1}}} &\system{ } u(n-1)\\
Z^{-1}\sbrak{\frac{z^{-2}}{(1-z^{-1})^2}}&\system {}  (n-1)u(n-2)\\
Z^{-1}\sbrak{\frac{z^{-3}}{(1-z^{-1})^3}}&\system {} \frac{(n-1)(n-2)}{2}u(n-3)\\
Z^{-1}\sbrak{\frac{z^{-4}}{(1-z^{-1})^4}}&\system  {} \frac{(n-1)(n-2)(n-3)}{6}u(n-4)
\end{align}
Now from ~\eqref{eq:11.9.4.10.eq}
\begin{align}
