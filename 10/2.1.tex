...
\begin{align}
 ...
 &=  \frac{1+z^{-1}}{(1-z^{-1})} + \frac{9z^{-2}}{(1-z^{-1})^2} + \frac{16z^{-3}}{(1-z^{-1})^3} + \frac{8z^{-4}}{(1-z^{-1})^4} \\
 &= \frac{9z^{-2}-2z^{-1}+1}{(1-z^{-1})^4} \\
...
&=\frac{(n+3)(n+2)(n+1)-2(n+2)(n+1)(n)+9(n+1)(n)(n-1)}{6}
\end{align}
On solving, we get
\begin{align}
    y\brak{n} &=\frac{4n^{3}-n+3}{3} 
\end{align}

Therefore, sum of $n$ terms of the series whose $n^{th}$ term is given by $(2n-1)^2$ is $\frac{4n^3-n+3}{3} $  .
