...
\begin{align}
 ...
 &=\frac{1}{(1-z^{-1})} +\frac{9z^{-1}}{(1-z^{-1})} + \frac{25z^{-2}}{(1-z^{-1})^2} + \frac{24z^{-3}}{(1-z^{-1})^3} + \frac{8z^{-4}}{(1-z^{-1})^4} \quad \abs{z}>1 
\end{align}

By using Z-transform pairs,
\begin{align}
Z^{-1}\sbrak{\frac{z^{-1}}{1-z^{-1}}}&= u(n-1) \\
Z^{-1}\sbrak{\frac{z^{-2}}{(1-z^{-1})^2}}&= (n-1)u(n-2) \\
Z^{-1}\sbrak{\frac{z^{-3}}{(1-z^{-1})^3}}&=\frac{(n-1)(n-2)}{2}u(n-3) \\
Z^{-1}\sbrak{\frac{z^{-4}}{(1-z^{-1})^4}}&= \frac{(n-1)(n-2)(n-3)}{6}u(n-4)
\end{align}

\begin{align}
  y\brak{n}&= u(n) + 9u(n-1) + 25(n-1)u(n-2) + 24\frac{(n-1)(n-2)}{2}u(n-3) + 8\frac{(n-1)(n-2)(n-3)}{6}u(n-4) \\
\implies  y\brak{n} &=(\frac{4n^{3}+12n^{2}+11n+3}{3} )u(n)
\end{align}
